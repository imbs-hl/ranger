...
#include "../inst/include/rangerts.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
RcppExport SEXP _rangerts_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rangerts_rangertsCpp", (DL_FUNC) &_rangerts_rangertsCpp, 50},
    {"_rangerts_numSmaller", (DL_FUNC) &_rangerts_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rangerts(DllInfo *dll) {
