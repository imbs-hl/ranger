...
public:
  ...
  const std::vector<std::vector<std::vector<size_t>>>& getSelectedVariables() const {
...
protected:
  ...
  // Save selected variables for each tree and split
  std::vector<std::vector<std::vector<size_t>>> selected_variables;
