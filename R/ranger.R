...
##' This importance measure can be combined with the methods to estimate p-values in \code{\link{importance_pvalues}}. It should not be used when making predictions since the feature permutation step reduces performance (a warning is raised when predicting on new data). 
##'
