...
##' @param risk.set.size Number of individuals in the risk set for each split in survival trees. 0 (the default) corresponds to all individuals in the node.
...
ranger <- function(formula = NULL, data = NULL, num.trees = 500, mtry = NULL,
  ...
  result <- rangerCpp(treetype, x, y.mat, independent.variable.names, mtry,
                      ...
                      node.stats, time.interest, use.time.interest, any.na, risk.set.size)
