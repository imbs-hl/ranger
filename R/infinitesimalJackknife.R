...
# Compute variance of estimate from a rangerts model
#
# Computes variances for a prediction from a rangerts model, using the infinitesimal jackknife procedure
#
# This function is a rangerts-adaptation of the package \pkg{randomForestCI} of Wager et al. (2014). Their original can be found on github: \url{ https://github.com/swager/randomForestCI/}.
#
